        ...
        Column {
            ...
            Column {
                ...
                Timer {
                    ...
                    repeat: true
                    onTriggered: {
                        x_reading.text = "X: " + accelerometer.reading.x
                        y_reading.text = "Y: " + accelerometer.reading.y
                        z_reading.text = "Z: " + accelerometer.reading.z
                        //calibration_number.text = "Calibration level: " +accelerometer.reading.calibrationLevel
                        //console.log("Calibration level: ", accelerometer.reading.calibrationLevel)

                        page.x_value = accelerometer.reading.x * 100
                        ...
                        page.y_value = accelerometer.reading.y * 100
                        ...
                        page.z_value = accelerometer.reading.z * 100
