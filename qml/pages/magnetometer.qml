        ...
        Column {
            ...
            Column {
                ...
                Timer {
                    ...
                    repeat: true
                    onTriggered: {
                        x_reading.text = "X: " + magnetometer.reading.x
                        y_reading.text = "Y: " + magnetometer.reading.y
                        z_reading.text = "Z: " + magnetometer.reading.z
                        //calibration_number.text = "Calibration level: " +magnetometer.reading.calibrationLevel
                        //console.log("Calibration level: ", magnetometer.reading.calibrationLevel)

                        page.x_value = magnetometer.reading.x * 10000000
                        ...
                        page.y_value = magnetometer.reading.y * 10000000
                        ...
                        page.z_value = magnetometer.reading.z * 10000000
